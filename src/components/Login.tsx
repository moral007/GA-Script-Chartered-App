...
const Login: React.FC = () => {
  ...
  const { setUser } = useAuth(); // Directly set user
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  id="password"
                  type="password"
                  placeholder="Enter your password (ignored)"
                  value={password}
        ...
        <Card className="bg-gradient-to-r from-green-50 to-teal-50 border-green-200">
          <CardContent className="p-4">
            ...
            <div className="space-y-2 text-sm text-green-800">
              <p>• <strong>Any email/password</strong> will now log in</p>
              <p>• After login, you’ll be redirected to the homepage (`/`)</p>
              <p>• Demo buttons just fill fields — login bypasses everything</p>
            </div>
          </CardContent>
        </Card>
      </div>
